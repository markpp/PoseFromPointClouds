...
if __name__ == '__main__':
    ...
    """
    in_path = 'grasps/tensors' # 'corl2017_experiments/tensors'
    ...
    for idx in range(1557)[:10]:
        ...
        for i in range(100):
            ...
            out_path = 'output/{}'.format(object_class)
            if not os.path.exists(out_path):
                os.makedirs(out_path)

            #print("split type: {}".format(splits[i]))
