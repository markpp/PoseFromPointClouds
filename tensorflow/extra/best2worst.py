...
if __name__ == '__main__':
    ...
    gt = np.load('../{}/test_Y.npy'.format(data_source),allow_pickle=True)
    pred = np.load('../{}/test_pred.npy'.format(data_source),allow_pickle=True)
    x = np.load('../{}/test_X.npy'.format(data_source),allow_pickle=True)
    x = sample_x(x, 1024)
